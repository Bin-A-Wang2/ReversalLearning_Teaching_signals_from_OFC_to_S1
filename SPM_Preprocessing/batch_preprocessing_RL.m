function batch_preprocessing_RL(Subject)
...
for i=1:length(Subject)
    ...
    inputpath= [RootDir,'Preprocessing_RL\',prfx,num2str(sub,'%.2d')];
    cd (inputpath);
    %% find the path for NIFTI EPI data in 3 RUNS
    
    for j=1:Nr_run
        
        rawpath=[inputpath,'\RUN',num2str(j),'\'];
        rawdata=dir(rawpath);
        
        for n=1:(length(rawdata)-2)
            rawfile{n,1}=[rawpath,rawdata(n+2).name];
        end
        
        EPIfile_all{1,j}=rawfile;
    end
    
    %% find the path for T1 NIFTI
    T1path=[inputpath,'\T1\'];
    T1dir=dir(T1path);
    
    T1file={[T1path,T1dir(3).name]};
    ...
    %Realign (Est&Res)
    matlabbatch{1}.spm.spatial.realign.estwrite.data = EPIfile_all;
    ...
    matlabbatch{2}.spm.spatial.coreg.estimate.source = T1file;
    ...
    matlabbatch{3}.spm.spatial.preproc.tissue(1).tpm = {'D:\Bochum\toolbox\spm12\tpm\TPM.nii,1'};
    matlabbatch{3}.spm.spatial.preproc.tissue(1).ngaus = 1;
    matlabbatch{3}.spm.spatial.preproc.tissue(1).native = [1 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(1).warped = [0 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(2).tpm = {'D:\Bochum\toolbox\spm12\tpm\TPM.nii,2'};
    matlabbatch{3}.spm.spatial.preproc.tissue(2).ngaus = 1;
    matlabbatch{3}.spm.spatial.preproc.tissue(2).native = [1 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(2).warped = [0 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(3).tpm = {'D:\Bochum\toolbox\spm12\tpm\TPM.nii,3'};
    matlabbatch{3}.spm.spatial.preproc.tissue(3).ngaus = 2;
    matlabbatch{3}.spm.spatial.preproc.tissue(3).native = [1 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(3).warped = [0 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(4).tpm = {'D:\Bochum\toolbox\spm12\tpm\TPM.nii,4'};
    matlabbatch{3}.spm.spatial.preproc.tissue(4).ngaus = 3;
    matlabbatch{3}.spm.spatial.preproc.tissue(4).native = [1 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(4).warped = [0 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(5).tpm = {'D:\Bochum\toolbox\spm12\tpm\TPM.nii,5'};
    matlabbatch{3}.spm.spatial.preproc.tissue(5).ngaus = 4;
    matlabbatch{3}.spm.spatial.preproc.tissue(5).native = [1 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(5).warped = [0 0];
    matlabbatch{3}.spm.spatial.preproc.tissue(6).tpm = {'D:\Bochum\toolbox\spm12\tpm\TPM.nii,6'};
