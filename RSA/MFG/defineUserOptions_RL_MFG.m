function userOptions = defineUserOptions_RL_MFG()
%
...
userOptions.betaPath = ['D:\Bochum\DATA\fMRI_RL_GoNoGo\Results_OFC_S1\Participants\','[[subjectName]]',filesep,'Results_outcome_LNLERNRE_cue_RSA',filesep,'[[betaIdentifier]]'];% e.g. /imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[betaIdentifier]]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	userOptions.maskPath = ['D:\Bochum\DATA\fMRI_RL_GoNoGo\Results_OFC_S1\Results_RSA\Mask\[[maskName]].nii'];%'/imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[maskName]].img';
