...
userOptions = defineUserOptions_RL_MFG();
compareRDM=0;
%%
for i= 1:length(conditionLabels)
    ...
    if i==1
        userOptions.rootPath = 'D:\Bochum\DATA\fMRI_RL_GoNoGo\Results_OFC_S1\Results_RSA\Results_MFG\RDMs_LERN';
    elseif i==2
        userOptions.rootPath = 'D:\Bochum\DATA\fMRI_RL_GoNoGo\Results_OFC_S1\Results_RSA\Results_MFG\RDMs_LERE';
    end
    mkdir(userOptions.rootPath)
