...
function batch_spm12_gPPI_RL(RootDir,Subjects,VOIname,VOIxyz,VOIradius,analysis_dir,condition_name)  
...
%%
%VOIname='OFC_RSA_38_36_-10_r6';
%VOIname='OFC_RSA_50_34_-16_r6';
%VOIname='S1_RSA_30_-36_58_r6';
%VOIname='MFG_44_22_30_r6';

%VOIxyz=[50 34 -16];  %
%VOIradius = 6;
%analysis_dir='Results_outcome_LNLERNRE_cue_PPI_3sess';
%condition_name={'outcome_LE','outcome_RN'};
%contrast_name='PPI_RN_minus_LE';

%batch_spm12_gPPI_RL(RootDir,Subjects,VOIname,VOIxyz,VOIradius,analysis_dir,condition_name)  

%batch_1stlevel_PPI_CompContrasts_RL(RootDir,Subjects,VOIname,contrast_name)
 
%batch_2ndlevel_gPPI_RL(RootDir,Subjects,VOIname,contrast_name)
%%
for i = 1:length(Subjects)
    
    fprintf('Working on participant %d\n',Subjects(i));
    
    inputpath= fullfile(RootDir,'\Results_OFC_S1\Participants', sprintf('Sub%02d',Subjects(i)),analysis_dir);
    gPPI_dir=  fullfile(RootDir,'\Results_OFC_S1\Participants', sprintf('Sub%02d',Subjects(i)));
